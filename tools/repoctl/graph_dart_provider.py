...
def build_dart_semantics(
    *,
    ...
    try:
        ...
        rpc_analyzed, rpc_failed = parse_provider_coverage(
            data,
            eligible_paths=selected_paths,
            analyzed_field="rpc_analyzed_paths",
            failed_field="rpc_failed_paths",
        )
        ...
        return _unavailable(
            selected,
            code="dart_provider_invalid_output",
            message=f"Dart analyzer provider output is invalid: {exc}",
        )
