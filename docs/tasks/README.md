...
Agents and humans write task meaning in Markdown. repoctl alone writes `.repoctl-state` baseline data, fingerprints, resume bindings, ownership decisions, completion receipts, Closure, Board changes, and archive transitions.
