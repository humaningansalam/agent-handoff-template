...
- The outcome contract owns canonical member capsules, explicit episode dispositions, completion-bound verification, and bounded later-query corroboration; producer result receipts remain flat selections that Discovery validates before freezing a capsule.
